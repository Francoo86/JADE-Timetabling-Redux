...
public class AgenteProfesorFSM extends Agent {
    ...
    protected void setup() {
        ...
        NegotiationFSMBehaviour stateBehaviour = new NegotiationFSMBehaviour(this, batchProposals);
        ...
        if (orden == 0) {
            ...
            addBehaviour(new EsperarTurnoBehaviourFSM(this, stateBehaviour));
        }
