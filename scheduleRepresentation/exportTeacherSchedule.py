...
def create_teacher_schedule(teacher_data):
    ...
    days = [day.upper() for day in days]  # Convert to uppercase
    ...
    for subject in teacher_data['Asignaturas']:
        ...
        day = subject['Dia'].upper()  # Convert day to uppercase
...
def save_schedules(data, filename='teacher_schedules_jade.xlsx'):
